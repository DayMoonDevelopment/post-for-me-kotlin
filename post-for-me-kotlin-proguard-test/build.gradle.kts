...
dependencies {
    testImplementation(project(":post-for-me-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../post-for-me-kotlin-core/src/main/resources/META-INF/proguard/post-for-me-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.post_for_me.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../post-for-me-kotlin-core/src/main/resources/META-INF/proguard/post-for-me-kotlin-core.pro",
