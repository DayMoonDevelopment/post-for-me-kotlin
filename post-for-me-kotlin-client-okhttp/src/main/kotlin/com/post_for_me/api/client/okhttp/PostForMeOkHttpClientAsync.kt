...
package com.post_for_me.api.client.okhttp
...
/**
 * A class that allows building an instance of [PostForMeClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class PostForMeOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [PostForMeClientAsync]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): PostForMeClientAsync = builder().fromEnv().build()
    }

    /** A builder for [PostForMeOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [PostForMeClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PostForMeClientAsync =
            PostForMeClientAsyncImpl(
                clientOptions
                    .httpClient(
