...
import com.post_for_me.api.client.PostForMeClientImpl
...
/**
 * A class that allows building an instance of [PostForMeClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class PostForMeOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [PostForMeClient]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): PostForMeClient = builder().fromEnv().build()
    }

    /** A builder for [PostForMeOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [PostForMeClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PostForMeClient =
            PostForMeClientImpl(
                clientOptions
                    .httpClient(
