...
import com.post_for_me.api.core.http.HttpRequestBody
import com.post_for_me.api.core.http.HttpResponse
import com.post_for_me.api.errors.PostForMeIoException
...
class OkHttpClient private constructor(private val okHttpClient: okhttp3.OkHttpClient) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw PostForMeIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("POST_FOR_ME_LOG")?.lowercase()) {
