...
interface SocialAccountFeedServiceAsync {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): SocialAccountFeedServiceAsync
    ...
    /**
     * A view of [SocialAccountFeedServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * is otherwise the same as [SocialAccountFeedServiceAsync.list].
         */
        @MustBeClosed
        suspend fun list(
            socialAccountId: String,
