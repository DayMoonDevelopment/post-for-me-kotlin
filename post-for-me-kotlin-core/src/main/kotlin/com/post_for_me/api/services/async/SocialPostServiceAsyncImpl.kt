...
class SocialPostServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    SocialPostServiceAsync {

    private val withRawResponse: SocialPostServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): SocialPostServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): SocialPostServiceAsync =
        SocialPostServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            SocialPostServiceAsyncImpl.WithRawResponseImpl(
