 ...
 */
class SocialAccountFeedServiceAsyncImpl
internal constructor(private val clientOptions: ClientOptions) : SocialAccountFeedServiceAsync {

    private val withRawResponse: SocialAccountFeedServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): SocialAccountFeedServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(
        modifier: (ClientOptions.Builder) -> Unit
    ): SocialAccountFeedServiceAsync =
        SocialAccountFeedServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        SocialAccountFeedServiceAsync.WithRawResponse {
        ...
        override fun withOptions(
            ...
            SocialAccountFeedServiceAsyncImpl.WithRawResponseImpl(
