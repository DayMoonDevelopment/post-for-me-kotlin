...
/**
 * A client for interacting with the Post For Me REST API asynchronously. You can also switch to
 ...
 * may call [close].
 */
interface PostForMeClientAsync {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): PostForMeClientAsync

    fun media(): MediaServiceAsync

    fun socialPosts(): SocialPostServiceAsync

    fun socialPostResults(): SocialPostResultServiceAsync
    ...
    /**
     * A view of [PostForMeClientAsync] that provides access to raw HTTP responses for each method.
     */
    interface WithRawResponse {
        ...
        fun socialPosts(): SocialPostServiceAsync.WithRawResponse
