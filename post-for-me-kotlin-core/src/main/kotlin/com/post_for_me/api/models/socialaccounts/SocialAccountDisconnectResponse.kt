...
private constructor(
    ...
    /** A builder for [SocialAccountDisconnectResponse]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [SocialAccountDisconnectResponse].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SocialAccountDisconnectResponse && id == other.id && externalId == other.externalId && platform == other.platform && status == other.status && username == other.username && additionalProperties == other.additionalProperties /* spotless:on */
    }
