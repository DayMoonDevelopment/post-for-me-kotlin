...
private constructor(
    private val data: JsonField<List<SocialAccount>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<SocialAccount>> = JsonMissing.of(),
     ...
     */
    fun data(): List<SocialAccount> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<SocialAccount>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SocialAccountListResponse].
         *
    ...
    /** A builder for [SocialAccountListResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<SocialAccount>>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(socialAccountListResponse: SocialAccountListResponse) = apply {
            data = socialAccountListResponse.data.map { it.toMutableList() }
            meta = socialAccountListResponse.meta
            additionalProperties = socialAccountListResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<SocialAccount>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<SocialAccount>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<SocialAccount>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [SocialAccount] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: SocialAccount) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [SocialAccountListResponse].
         *
         ...
         */
        fun build(): SocialAccountListResponse =
    ...
    fun validate(): SocialAccountListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Meta && limit == other.limit && next == other.next && offset == other.offset && total == other.total && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(limit, next, offset, total, additionalProperties) }
        /* spotless:on */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SocialAccountListResponse && data == other.data && meta == other.meta && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "SocialAccountListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
