...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = threadsConfigurationDto.caption().convert(MyClass::class.java)
     * ```
     */
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ThreadsConfigurationDto]. */
        fun builder() = Builder()
    }

    /** A builder for [ThreadsConfigurationDto]. */
    class Builder internal constructor() {
        ...
        internal fun from(threadsConfigurationDto: ThreadsConfigurationDto) = apply {
            caption = threadsConfigurationDto.caption
            media = threadsConfigurationDto.media.map { it.toMutableList() }
            placement = threadsConfigurationDto.placement
            additionalProperties = threadsConfigurationDto.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ThreadsConfigurationDto].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ThreadsConfigurationDto =
    ...
    fun validate(): ThreadsConfigurationDto = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThreadsConfigurationDto &&
    ...
    override fun toString() =
        "ThreadsConfigurationDto{caption=$caption, media=$media, placement=$placement, additionalProperties=$additionalProperties}"
}
