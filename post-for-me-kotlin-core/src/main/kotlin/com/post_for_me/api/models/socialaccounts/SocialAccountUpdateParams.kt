...
class SocialAccountUpdateParams
private constructor(
    ...
    companion object {
        ...
        fun none(): SocialAccountUpdateParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [SocialAccountUpdateParams].
         */
        fun builder() = Builder()
    }

    /** A builder for [SocialAccountUpdateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(socialAccountUpdateParams: SocialAccountUpdateParams) = apply {
            id = socialAccountUpdateParams.id
            body = socialAccountUpdateParams.body.toBuilder()
            additionalHeaders = socialAccountUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = socialAccountUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SocialAccountUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SocialAccountUpdateParams =
    ...
    private constructor(
        ...
        ) : this(externalId, username, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(externalId, username, additionalProperties.toMutableMap())
        }
        ...
        override fun toString() =
            "Body{externalId=$externalId, username=$username, additionalProperties=$additionalProperties}"
    }
