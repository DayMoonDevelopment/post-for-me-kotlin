...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(socialPostResult: SocialPostResult) = apply {
            ...
            media = socialPostResult.media.map { it.toMutableList() }
    ...
    override fun toString() =
        "SocialPostResult{id=$id, details=$details, error=$error, media=$media, platformData=$platformData, postId=$postId, socialAccountId=$socialAccountId, success=$success, additionalProperties=$additionalProperties}"
}
