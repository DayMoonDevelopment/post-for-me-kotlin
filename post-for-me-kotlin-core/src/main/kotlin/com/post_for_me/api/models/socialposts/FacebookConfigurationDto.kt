...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = facebookConfigurationDto.caption().convert(MyClass::class.java)
     * ```
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(facebookConfigurationDto: FacebookConfigurationDto) = apply {
            ...
            collaborators = facebookConfigurationDto.collaborators.map { it.toMutableList() }
         ...
         *
         * You should usually call [Builder.collaborators] with a well-typed `List<List<JsonValue>>`
