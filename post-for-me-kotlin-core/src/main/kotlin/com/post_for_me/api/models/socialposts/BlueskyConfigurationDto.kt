...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = blueskyConfigurationDto.caption().convert(MyClass::class.java)
     * ```
     */
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BlueskyConfigurationDto]. */
        fun builder() = Builder()
    }

    /** A builder for [BlueskyConfigurationDto]. */
    class Builder internal constructor() {
        ...
        internal fun from(blueskyConfigurationDto: BlueskyConfigurationDto) = apply {
            caption = blueskyConfigurationDto.caption
            media = blueskyConfigurationDto.media.map { it.toMutableList() }
            additionalProperties = blueskyConfigurationDto.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BlueskyConfigurationDto].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BlueskyConfigurationDto =
     ...
     *   expected type.
     */
    fun validate(): BlueskyConfigurationDto = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BlueskyConfigurationDto &&
    ...
    override fun toString() =
        "BlueskyConfigurationDto{caption=$caption, media=$media, additionalProperties=$additionalProperties}"
}
