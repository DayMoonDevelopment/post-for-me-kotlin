...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = linkedinConfigurationDto.caption().convert(MyClass::class.java)
     * ```
     */
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [LinkedinConfigurationDto]. */
        fun builder() = Builder()
    }

    /** A builder for [LinkedinConfigurationDto]. */
    class Builder internal constructor() {
        ...
        internal fun from(linkedinConfigurationDto: LinkedinConfigurationDto) = apply {
            caption = linkedinConfigurationDto.caption
            media = linkedinConfigurationDto.media.map { it.toMutableList() }
            additionalProperties = linkedinConfigurationDto.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LinkedinConfigurationDto].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LinkedinConfigurationDto =
    ...
    fun validate(): LinkedinConfigurationDto = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LinkedinConfigurationDto &&
    ...
    override fun toString() =
        "LinkedinConfigurationDto{caption=$caption, media=$media, additionalProperties=$additionalProperties}"
}
