...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var platformConfigurations: JsonField<PlatformConfigurationsDto> = JsonMissing.of()
    ...
    private constructor(
        ...
        private constructor(
             ...
             * method:
             * ```kotlin
             * val myObject: MyClass = configuration.caption().convert(MyClass::class.java)
             * ```
             */
             ...
             * trial reel can be manually graduated in the native app. If perfomance the trial reel
             * will be automatically graduated if the trial reel performs well.
             *
             * @throws PostForMeInvalidDataException if the JSON field has an unexpected type (e.g.
             *   if the server responded with an unexpected value).
             */
             ...
             *
             * Unlike [trialReelType], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("trial_reel_type")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                /**
                 * Instagram trial reel type, when passed will be created as a trial reel. If manual
                 * the trial reel can be manually graduated in the native app. If perfomance the
                 * trial reel will be automatically graduated if the trial reel performs well.
                 */
                 ...
                 *
                 * You should usually call [Builder.trialReelType] with a well-typed [TrialReelType]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    @JsonProperty("tags")
                    @ExcludeMissing
                    tags: JsonField<List<Tag>> = JsonMissing.of(),
                ...
                @JsonProperty("thumbnail_url")
                @ExcludeMissing
                fun _thumbnailUrl(): JsonValue = thumbnailUrl
                 ...
                 *
                 * Unlike [skipProcessing], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("skip_processing")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                     ...
                     * this may increase chance of post failure if media does not meet platform's
                     * requirements. Best used for larger files.
                     */
                     ...
                     */
                    fun skipProcessing(skipProcessing: Boolean) =
                        skipProcessing(skipProcessing as Boolean?)

                    /**
                     * Sets [Builder.skipProcessing] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.skipProcessing] with a well-typed [Boolean]
                    ...
                    /** Public URL of the thumbnail for the media */
                    fun thumbnailUrl(thumbnailUrl: JsonValue) = apply {
                ...
                private constructor(
                     ...
                     *
                     * @throws PostForMeInvalidDataException if the JSON field has an unexpected
                    ...
                    /**
                     * The type of tag, user to tag accounts, product to tag products (only
                     * supported for instagram)
                     *
                     * @throws PostForMeInvalidDataException if the JSON field has an unexpected
                     *   type or is unexpectedly missing or null (e.g. if the server responded with
                     *   an unexpected value).
                     ...
                     *
                     * Unlike [platform], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("platform")
                    @ExcludeMissing
                    ...
                    class Builder internal constructor() {
                         ...
                         *
                         * You should usually call [Builder.platform] with a well-typed [Platform]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        fun platform(platform: JsonField<Platform>) = apply {
                        ...
                        /**
                         * Percentage distance from left edge of the image, Not required for videos
                         * or stories
                         */
                        ...
                        /**
                         * Percentage distance from top edge of the image, Not required for videos
                         * or stories
                         */
                     ...
                     * existing fields.
                     *
                     * @throws PostForMeInvalidDataException if any value type in this object
                    ...
                    private constructor(private val value: JsonField<String>) : Enum {
                        ...
                        /**
                         * An enum containing [Platform]'s known values, as well as an [_UNKNOWN]
                         * member.
                         *
                         * An instance of [Platform] can contain an unknown value in a couple of
                         * cases:
                        ...
                        enum class Value {
                            ...
                            INSTAGRAM,
                            /**
                             * An enum member indicating that [Platform] was instantiated with an
                             * unknown value.
                             */
                            _UNKNOWN,
                        }
                         ...
                         *
                         * @throws PostForMeInvalidDataException if this class instance's value is a
                         *   not a known member.
                         */
                        fun known(): Known =
                            when (this) {
                                ...
                                INSTAGRAM -> Known.INSTAGRAM
                                    ...
                                    throw PostForMeInvalidDataException("Unknown Platform: $value")
                            }
                         ...
                         *
                         * @throws PostForMeInvalidDataException if this class instance's value does
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                /**
                 * An enum containing [TrialReelType]'s known values, as well as an [_UNKNOWN]
                 * member.
                 *
                ...
                enum class Value {
                    ...
                    PERFORMANCE,
                    /**
                     * An enum member indicating that [TrialReelType] was instantiated with an
                     * unknown value.
                     */
                    _UNKNOWN,
                }
