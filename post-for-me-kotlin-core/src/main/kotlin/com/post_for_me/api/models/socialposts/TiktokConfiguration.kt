...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = tiktokConfiguration.caption().convert(MyClass::class.java)
     * ```
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(tiktokConfiguration: TiktokConfiguration) = apply {
            ...
            isDraft = tiktokConfiguration.isDraft
        ...
        /**
         * Will create a draft upload to TikTok, posting will need to be completed from within the
         * app
         */
