...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<SocialPost>> = JsonMissing.of(),
     ...
     */
    fun data(): List<SocialPost> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<SocialPost>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SocialPostListResponse].
         *
    ...
    /** A builder for [SocialPostListResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<SocialPost>>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(socialPostListResponse: SocialPostListResponse) = apply {
            data = socialPostListResponse.data.map { it.toMutableList() }
            meta = socialPostListResponse.meta
            additionalProperties = socialPostListResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<SocialPost>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<SocialPost>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<SocialPost>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [SocialPost] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: SocialPost) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [SocialPostListResponse].
         *
         ...
         */
        fun build(): SocialPostListResponse =
    ...
    fun validate(): SocialPostListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SocialPostListResponse && data == other.data && meta == other.meta && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "SocialPostListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
