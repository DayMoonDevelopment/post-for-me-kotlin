...
import com.post_for_me.api.core.MultipartField
...
private fun serializePart(name: String, node: JsonNode): Sequence<Pair<String, InputStream>> =
    when (node.nodeType) {
                    ...
                    node
                        ...
                        .mapNotNull { element ->
                            when (element.nodeType) {
                                ...
                                JsonNodeType.OBJECT,
                                JsonNodeType.POJO ->
                                    throw PostForMeInvalidDataException(
        ...
        JsonNodeType.POJO,
        null -> throw PostForMeInvalidDataException("Unexpected JsonNode type: ${node.nodeType}")
    }
