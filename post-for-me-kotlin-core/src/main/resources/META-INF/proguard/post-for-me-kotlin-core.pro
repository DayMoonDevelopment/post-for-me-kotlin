...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.post_for_me.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.post_for_me.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.post_for_me.api.** {
    <init>(...);
