    ...
    fun create() {
        val socialPostResult =
            SocialPostResult.builder()
                ...
                .addMedia(
                    SocialPostResult.Media.builder()
                        .url("url")
                        .skipProcessing(true)
                        .addTag(
                            SocialPostResult.Media.Tag.builder()
                                .id("id")
                                .platform(SocialPostResult.Media.Tag.Platform.FACEBOOK)
                                .type(SocialPostResult.Media.Tag.Type.USER)
                                .x(0.0)
                                .y(0.0)
                                .build()
                        )
        ...
        assertThat(socialPostResult.media())
            .containsExactly(
                SocialPostResult.Media.builder()
                    .url("url")
                    .skipProcessing(true)
