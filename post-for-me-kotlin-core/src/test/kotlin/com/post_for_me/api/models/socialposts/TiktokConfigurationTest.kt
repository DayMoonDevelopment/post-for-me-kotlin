...
internal class TiktokConfigurationTest {
    ...
    fun create() {
        ...
        assertThat(tiktokConfiguration.autoAddMusic()).isEqualTo(true)
        ...
        assertThat(tiktokConfiguration.isAiGenerated()).isEqualTo(true)
        assertThat(tiktokConfiguration.isDraft()).isEqualTo(true)
        assertThat(tiktokConfiguration.media())
            .containsExactly(
                TiktokConfiguration.Media.builder()
                    .url("url")
                    .thumbnailTimestampMs(JsonValue.from(mapOf<String, Any>()))
